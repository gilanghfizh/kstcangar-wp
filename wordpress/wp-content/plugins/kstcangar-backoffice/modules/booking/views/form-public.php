...
<!-- form-public.php: Form booking untuk pengunjung publik (via shortcode) -->
...
<div style="max-width:600px; margin:0 auto; font-family:sans-serif;">
    ...
    <div style="background:#f8d7da; color:#721c24; padding:16px; border-radius:8px; margin-bottom:24px; border:1px solid #f5c6cb;">
        <strong>❌ Gagal mengirim booking.</strong> Pastikan semua field wajib sudah diisi.
    </div>
    <?php endif; ?>
    ...
    <div style="background:#fff3cd; color:#856404; padding:16px; border-radius:8px; margin-bottom:24px; border:1px solid #ffc107;">
        <strong>⚠️ Slot penuh.</strong> Layanan yang dipilih sudah penuh untuk tanggal tersebut. Silakan pilih tanggal lain.
    </div>
    <?php endif; ?>
    ...
    <form method="POST" action="<?= admin_url('admin-post.php') ?>">
        ...
        <div style="margin-bottom:16px;">
            ...
            <select name="service_type" required
                ...
                <option value="glamping">🏕️ Glamping</option>
                <option value="cafe">☕ Café Eduwisata</option>
        ...
        <button type="submit"
                style="width:100%; padding:14px; background:#2d6a4f; color:#fff; border:none; border-radius:4px; font-size:16px; font-weight:bold; cursor:pointer;">
            Kirim Booking
        </button>
    </form>
</div>
