    ...
    <main class="main-content">
        ...
        <div class="so-stats-grid">
            <div class="so-stat-card">
                ...
                <strong id="total-awal">500</strong>
            </div>
            <div class="so-stat-card">
                ...
                <strong id="total-masuk">350</strong>
            </div>
            <div class="so-stat-card">
                ...
                <strong id="total-keluar">200</strong>
            </div>
            <div class="so-stat-card">
                ...
                <strong id="total-retur">10</strong>
            </div>
        </div>
...
let activeMonth = <?php echo date('n'); ?>;
let activeYear  = <?php echo date('Y'); ?>;

async function loadStokFromAPI(){
...
masuk:
item.masuk || [0,0,0,0,0,0,0],

keluar:
item.keluar || [0,0,0,0,0,0,0],
...
bulan:
item.bulan || activeMonth,

tahun:
item.tahun || activeYear
...
alert(
"Backend POST stok belum dihubungkan"
);
...
alert(
"Backend DELETE stok belum dihubungkan"
);
